...
public class EatWellRice extends AppCompatActivity implements View.OnClickListener

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eat_well_rice);
        listView=(ListView)findViewById(R.id.happy2);
        eatWellAllTimeBeans =new ArrayList<>();
        eatWellAllTimeBeans .add(new EatWellAllTimeBean("Cheese Pulao", "Rice cooked with cheese and spices", "Rs", 304));
        eatWellAllTimeBeans.add(new EatWellAllTimeBean("Kaikari Biryani", "", "Rs", 210));
        eatWellAllTimeBeans.add(new EatWellAllTimeBean("Vegetable Pulao", "Rice stuffed with mix vegetables served with curd and pickles", "Rs", 142));
        eatWellAllTimeBeans.add(new EatWellAllTimeBean("Steamed Rice", "Steamed fluffy rice", "Rs", 280));
        eatWellAllTimeBeans.add(new EatWellAllTimeBean("Bagala Bhath", "", "Rs", 220));
