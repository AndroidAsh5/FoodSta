...
public class SinghMenu extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    void initViews() {
        ...
        personlist.add(new SinghMenuBean("Popular Products"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singh_menu);
        initViews();
    }
    @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position) {
            case 1:
                Intent z = new Intent(this, SinghPopularProducts.class);
                startActivity(z);
                break;
