...
public class uuipopular extends AppCompatActivity implements View.OnClickListener    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uuipopular);
        listView=(ListView)findViewById(R.id.happy2);
        singhPopularProductsBeans =new ArrayList<>();
        singhPopularProductsBeans .add(new SinghPopularProductsBean("ka Roll", "Malai paneer tikka with sauce and spices wrapped in a thin flatbread", "Rs", 137));
...
//        yelloChilliStartersBeans.add(new YelloChilliStartersBean("manchurian",121));
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.buttonshow4){
            ...
            Intent ne =new Intent(this,showcartuui.class);
            startActivity(ne);
        }
